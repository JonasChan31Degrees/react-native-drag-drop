...
class ItemsContainer extends Container {
    ...
    render() {
        const { itemsContainerStyle, layout, dragging, itemKeyExtractor, onGrant, addedHeight, renderItem, onDragEnd, changed, onDrag, itemsContainerHeightFixe, draggedElementStyle, itemsInZoneStyle, items, itemsDisplay, numCollumns, } = this.props;
        ...
        return (React.createElement(View, { onLayout: (e) => {
                this.onSetLayout(e);
            }, style: [newStyle, itemsContainerStyle] }, items.map((item) => {
