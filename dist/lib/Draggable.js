...
class Draggable extends Component {
    ...
    render() {
        ...
        return (React.createElement(Animated.View, { ...this.panResponder?.panHandlers, style: [panStyle, style] },
            React.createElement(TouchableOpacity, { delayLongPress: 100, onLongPress: () => this.setState({ pressed: true }, () => { }), onPress: this.onPress, ...this.props.propsInItems }, this.props.children)));
    }
}
